...
import Book from "../sourcesTurabian/book";
import OnlineImage from "../sourcesTurabian/OnlineImage";
import Film from "../sourcesTurabian/film";

class Turabian extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
