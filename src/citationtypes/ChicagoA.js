...
import Book from "../sourcesChicago/book";
import OnlineImage from "../sourcesChicago/OnlineImage";
import Film from "../sourcesChicago/film";

class ChicagoA extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
