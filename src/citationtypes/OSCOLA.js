...
import Book from "../sourcesOscola/book";
import OnlineImage from "../sourcesOscola/OnlineImage";
import Film from "../sourcesOscola/film";

class Oscola extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
