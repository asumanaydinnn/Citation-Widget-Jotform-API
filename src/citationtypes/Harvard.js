...
import Book from "../sourcesHarvard/book";
import OnlineImage from "../sourcesHarvard/OnlineImage";
import Film from "../sourcesHarvard/film";

class Harvard extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
